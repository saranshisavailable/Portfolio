    ...
    return (
        <div id='home' className='bg-[#0a192f] h-screen w-full'>
            ...
            <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
                ...
                <h1 className='text-4xl sm:text-7xl font-bold text-[#ccd6f6] '> Saransh Sharma</h1>
                ...
                <div className='text-[#E5E7EB]  '>
                    <button className='flex group items-center gap-2 border-2 px-6 py-3 hover:bg-pink-600 hover:border-pink-600 '   >
                        View Work  <span className='group-hover:rotate-90 duration-300'>  <HiArrowNarrowRight />
                        </span>  </button>
                </div>
