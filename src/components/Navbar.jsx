...
import logo from '../assets/ssfinal.png'
...
const Navbar = () => {
    ...
    return (
        <>
            <div className='fixed h-[80px] bg-[#0a192f] w-full flex justify-between items-center text-gray-300 px-4'>
                <div className=''>
                    <img src={logo} alt="my-initials" className='h-[80px]' />
                </div>

                <ul className='hidden md:flex justify-evenly gap-12 items-center'>
